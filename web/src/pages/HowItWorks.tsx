    ...
    <div className="site-shell">
      ...
      <header className="page-hero">
        <div className="page-hero-inner reveal reveal-up" data-reveal>
          ...
          <p>
            From the moment an SMS lands on a Filipino subscriber&apos;s phone
            to the moment it is surfaced as part of a tracked campaign, six
            stages run entirely on-device and in the BantAI intelligence backend
            — combining multilingual NLP, explainable AI, and unsupervised
            clustering.
          </p>
        </div>
      </header>
...
function ClusterDotsIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none" aria-hidden="true">
      ...
      <path
        d="M8 8.5L11 16M16 8.5L13 16M8.5 7H15.5"
        stroke="currentColor"
        strokeWidth="1.4"
      />
    </svg>
