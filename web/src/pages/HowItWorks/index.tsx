...
export const HowItWorksPage: React.FC = () => {
  const [activeStepHover, setActiveStepHover] = React.useState<string | null>(
    null,
  );
    ...
    <div className="public-shell" style={{ position: 'relative' }}>
      ...
      >
        ...
        <g fill="none" stroke="rgba(56, 189, 248, 0.75)" strokeWidth="2">
          ...
          <polygon
            points="1340,180 1320,215 1280,215 1260,180 1280,145 1320,145"
        ...
        <g fill="none" stroke="rgba(56, 189, 248, 0.7)" strokeWidth="2">
          ...
          <polygon
            points="180,480 162,510 127,510 110,480 127,450 162,450"
        ...
        <g fill="none" stroke="rgba(56, 189, 248, 0.75)" strokeWidth="2">
          ...
          <polygon
            points="1200,840 1182,870 1147,870 1130,840 1147,810 1182,810"
      ...
      <main style={{ flex: 1, position: 'relative', zIndex: 1 }}>
        ...
        >
          ...
          >
            From raw SMS telemetry to campaign surfacing, BantAI combines
            multilingual Taglish NLP, SHAP explainability, and HDBSCAN density
            clustering into an automated end-to-end threat intelligence
            pipeline.
          </p>
          ...
          >
            <div
              ...
              style={{
                background:
                  'linear-gradient(145deg, rgba(30, 41, 75, 0.5) 0%, rgba(15, 23, 42, 0.75) 100%)',
            ...
            >
              ...
              <div>
                ...
                >
                  Real-time telemetry ingestion and inference
                </small>
              </div>
            </div>
            ...
            <div
              ...
              style={{
                background:
                  'linear-gradient(145deg, rgba(40, 30, 75, 0.5) 0%, rgba(18, 15, 42, 0.75) 100%)',
                backdropFilter: 'blur(16px)',
            ...
            >
              ...
              <div>
                ...
                >
                  Fine-tuned on Tagalog, Taglish & English lures
                </small>
              </div>
            </div>
            ...
            <div
              ...
              style={{
                background:
                  'linear-gradient(145deg, rgba(16, 45, 40, 0.5) 0%, rgba(10, 24, 22, 0.75) 100%)',
                backdropFilter: 'blur(16px)',
            ...
            >
              ...
              <div>
                ...
                >
                  Syndicated threat group identification
                </strong>
              </div>
            </div>
          </div>
        ...
        >
          <div
            ...
            style={{
              background:
                'linear-gradient(145deg, rgba(15, 23, 42, 0.7) 0%, rgba(10, 16, 30, 0.9) 100%)',
        ...
        >
          ...
          <div
            ...
            style={{
              ...
              borderRadius: 22,
              background:
                'linear-gradient(135deg, rgba(124, 58, 237, 0.22) 0%, rgba(37, 99, 235, 0.18) 50%, rgba(10, 14, 28, 0.95) 100%)',
              border: '1px solid rgba(139, 92, 246, 0.4)',
              boxShadow:
                '0 0 40px rgba(124, 58, 237, 0.2), 0 20px 50px rgba(0, 0, 0, 0.5), inset 0 1px 0 rgba(255, 255, 255, 0.15)',
              textAlign: 'center',
            }}
          >
            <div
            ...
            >
              Explore the detailed benchmarks, loss functions, tokenization
              schemas, and clustering metrics behind our fine-tuned XLM-RoBERTa
              model and HDBSCAN pipeline.
            </p>
