    ...
    <div className="public-shell" style={{ position: 'relative' }}>
      ...
      >
        ...
        <g fill="none" stroke="rgba(56, 189, 248, 0.75)" strokeWidth="2">
          ...
          <polygon
            points="1200,70 1177,109 1132,109 1110,70 1132,31 1177,31"
        ...
        <g fill="none" stroke="rgba(56, 189, 248, 0.7)" strokeWidth="2">
          ...
          <polygon
            points="185,440 167,470 132,470 115,440 132,410 167,410"
        ...
        <g fill="none" stroke="rgba(56, 189, 248, 0.75)" strokeWidth="2">
          ...
          <polygon
            points="1180,780 1162,810 1127,810 1110,780 1127,750 1162,750"
      ...
      <main style={{ flex: 1 }}>
        ...
        >
          ...
          >
            BantAI investigates multilingual SMS fraud detection, campaign
            clustering, and explainability for the Philippine mobile threat
            environment.
          </p>
        </section>
        ...
        >
          ...
          >
            ...
            <h2
              style={{ fontSize: '2rem', marginBottom: 12, color: '#ffffff' }}
            >
            ...
            >
              Move from the academic framing into the operating detection
              pipeline or the live portal.
            </p>
            <div
              style={{
                display: 'flex',
