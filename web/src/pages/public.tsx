...
export function RequestAccessPage() {
  ...
  const setStage = (next: Stage) =>
    navigate('/request-access', { state: { stage: next } });
  ...
  return (
    ...
    >
      ...
      >
        {stage === 'licensing' ? (
          <LicensingStage onNext={() => setStage('submission')} />
        ) : null}
        {stage === 'submission' ? (
          <SubmissionStage onNext={() => setStage('pending')} />
        ) : null}
        {stage === 'pending' ? (
          <PendingStage onNext={() => setStage('proposal')} />
        ) : null}
        {stage === 'proposal' ? (
          <ProposalStage onNext={() => setStage('payment')} />
        ) : null}
        {stage === 'payment' ? (
          <PaymentStage onNext={() => setStage('granted')} />
        ) : null}
        {stage === 'granted' ? (
          <GrantedStage onNext={() => navigate('/client/overview')} />
        ) : null}
      </main>
    </div>
  );
...
function LicensingStage({ onNext }: { onNext: () => void }) {
  const [selectedOrg, setSelectedOrg] = React.useState<'telecom' | 'cyber'>(
    'telecom',
  );
  ...
  return (
    ...
    >
      ...
      >
        Premium data licensing for verified telecommunications and cybersecurity
        organizations.
      </p>
...
function SubmissionStage({ onNext }: { onNext: () => void }) {
  ...
  const [description, setDescription] = React.useState(
    'Monitor smishing campaigns targeting Globe subscribers for fraud prevention operations.',
  );
  ...
  const isValid =
    isOrgNameValid && isFullNameValid && isEmailValid && isDescValid;
  ...
  const getInputStyle = (fieldName: string, hasError: boolean) => ({
    ...
    outline: 'none',
    boxShadow:
      focusedField === fieldName ? '0 0 14px rgba(59, 130, 246, 0.35)' : 'none',
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            'linear-gradient(180deg, rgba(20, 20, 32, 0.95) 0%, rgba(12, 12, 18, 0.98) 100%)',
          border: '1px solid var(--border-default)',
          borderTop: '3px solid #2563eb',
          borderRadius: 16,
          padding: '24px 32px',
          boxShadow:
            '0 16px 40px rgba(0, 0, 0, 0.6), 0 0 25px rgba(37, 99, 235, 0.15)',
        }}
      >
        ...
        >
          ...
          >
            <div>
              ...
              <input
                ...
                style={getInputStyle(
                  'orgName',
                  Boolean(touched.orgName && !isOrgNameValid),
                )}
            ...
            <div>
              ...
              <input
                ...
                style={getInputStyle(
                  'fullName',
                  Boolean(touched.fullName && !isFullNameValid),
                )}
          ...
          <div>
            ...
            <input
              ...
              style={getInputStyle(
                'email',
                Boolean(touched.email && !isEmailValid),
              )}
          ...
          <div>
            ...
            <textarea
              ...
              style={{
                ...getInputStyle(
                  'description',
                  Boolean(touched.description && !isDescValid),
                ),
                resize: 'none',
              }}
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          alignItems: 'center',
          boxShadow:
            '0 16px 40px rgba(0, 0, 0, 0.6), 0 0 25px rgba(245, 158, 11, 0.15)',
        }}
      >
        ...
        >
          The BantAI Research Team will verify your organization credentials and
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
            ...
            >
              ...
              <div>
                ...
                >
                  Pending Verification email sent to you
                </strong>
                <small
                  style={{ fontSize: '0.75rem', color: 'var(--text-muted)' }}
                >
            ...
            >
              ...
              <div>
                ...
                >
                  New license request alert sent to BantAI admin
                </strong>
                <small
                  style={{ fontSize: '0.75rem', color: 'var(--text-muted)' }}
                >
                  Review queued in BantAI Security Command
                </small>
              </div>
            </div>
          </div>
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          alignItems: 'center',
          boxShadow:
            '0 16px 40px rgba(0, 0, 0, 0.6), 0 0 25px rgba(16, 185, 129, 0.15)',
        }}
      >
        {/* Pulsing Status Circle Icon */}
        <div
        ...
        >
          Your Formal Licensing Proposal and Digital Invoice are approved and
          ready for download.
        </p>
        ...
        >
          ...
          >
            ...
            <button
              type="button"
              onClick={() =>
                handleDownload('Formal_Licensing_Proposal_BantAI.pdf')
              }
              className="campaign-card-interactive"
              style={{
                padding: '9px 16px',
                ...
                borderRadius: 8,
                background:
                  'linear-gradient(135deg, rgba(37, 99, 235, 0.35) 0%, rgba(59, 130, 246, 0.25) 100%)',
          ...
          >
            ...
            <button
              type="button"
              onClick={() =>
                handleDownload('Digital_Invoice_INV-2026-0047.pdf')
              }
              className="campaign-card-interactive"
              style={{
                padding: '9px 16px',
                ...
                borderRadius: 8,
                background:
                  'linear-gradient(135deg, rgba(16, 185, 129, 0.35) 0%, rgba(52, 211, 153, 0.25) 100%)',
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          padding: '28px 32px',
          boxShadow:
            '0 16px 40px rgba(0, 0, 0, 0.6), 0 0 25px rgba(96, 165, 250, 0.15)',
        }}
      >
        <h2
          style={{
        ...
        >
          <div>
            ...
            >
              BantAI Intelligence License — Annual
            </strong>
            <small style={{ fontSize: '0.75rem', color: 'var(--text-muted)' }}>
              INV-2026-0047 — Enterprise Subscription
            </small>
          </div>
          <strong
            style={{
            ...
            >
              ...
              <div>
                ...
                <small
                  style={{ fontSize: '0.75rem', color: 'var(--text-muted)' }}
                >
                  Direct wire transfer — recommended for government &amp;
                  enterprise
                </small>
              </div>
            </div>
          ...
          >
            ...
            <div>
              ...
              <small
                style={{ fontSize: '0.75rem', color: 'var(--text-muted)' }}
              >
                Secure enterprise gateway — 256-bit SSL PCI-DSS compliant
              </small>
            </div>
          </div>
        </div>
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          alignItems: 'center',
          boxShadow:
            '0 16px 40px rgba(0, 0, 0, 0.6), 0 0 30px rgba(16, 185, 129, 0.2)',
        }}
      >
        ...
        >
          Payment confirmed. Your organization's portal access has been fully
          activated.
        </p>
      ...
      <div className="auth-card">
        ...
        {admin ? (
          <div className="warning-strip">
            Super Admin Access --- Authorized Personnel Only
          </div>
        ) : null}
        <div className="auth-form">
          {admin ? null : <Field label="Organization" value="Globe Telecom" />}
          <Field
            label={admin ? 'Admin Email' : 'Email address'}
            value={admin ? 'admin@bantai.research' : 'analyst@globe.com.ph'}
          />
          <Field label="Password" value="........" eye />
          <button
            className="primary-btn wide"
            type="button"
            onClick={() => navigate('/2fa', { state: { admin } })}
          >
        ...
        <small>
          {admin
            ? 'This portal is restricted to the BantAI Research team only.'
            : 'Access is restricted to authorized organizations only.'}
        </small>
        <div className="auth-link">
          {admin ? (
            <>
              Client organization?{' '}
              <Link to="/login">Sign In to the Client Portal ---&gt;</Link>
            </>
          ) : (
            <>
    ...
    <div className="auth-shell">
      <div className="auth-card narrow">
        ...
        <p>
          ...
          <br />
          <a href="#">
            {admin ? 'g****@bantai.research' : 'a****@globe.com.ph'}
          </a>
        </p>
        ...
        <small>
          Code expires in <span className="tone-amber">04:47</span>
        </small>
        <button
          className="primary-btn wide"
          type="button"
        ...
        <small>
          --- <Link to={admin ? '/admin-login' : '/login'}>Back to login</Link>
        </small>
      </div>
    </div>
  );
