    ...
    <div className="site-shell">
      ...
      <header className="page-hero">
        <div className="page-hero-inner reveal reveal-up" data-reveal>
          ...
          <p>
            BantAI&apos;s underlying research spans the smishing threat
            landscape, multilingual NLP for code-switched Filipino text, and
            unsupervised methods for surfacing coordinated campaigns from
            independently reported messages.
          </p>
        </div>
      </header>
      ...
      <section className="section">
        <div className="citation-card reveal reveal-up" data-reveal>
          ...
          <p className="citation-entry">
            Castro, A., De Castro, D., &amp; Mendoza, R. (2026).{' '}
            <em>
              BantAI: Multilingual Campaign Intelligence for Philippine SMS
              Smishing Detection
            </em>
            . Undergraduate Thesis, College of Information Technology and
            Engineering, De La Salle Lipa.
          </p>
        </div>
      </section>
