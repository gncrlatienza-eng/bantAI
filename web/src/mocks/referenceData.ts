...
export const adminSidebar: NavSection[] = [
  ...
  {
    title: 'USER REPORTS',
    items: [{ label: 'User Reports', path: '/admin/reports' }],
  },
  {
    title: 'MODEL',
    items: [
  ...
  {
    title: 'CLIENTS',
    items: [{ label: 'Registered Users', path: '/admin/users' }],
  },
...
export const clientMessages: TableData = {
  ...
  rows: [
    ...
    [
      '#MSG-4820',
      '+63 917 231 5500',
      "Congratulations! You've been selected for a P5,000 GCash reward. Claim at...",
      'Op. GCash Clone #17',
      '91%',
      'Smishing',
      'May 13, 8:47 AM',
    ...
    [
      '#MSG-4819',
      '+63 2 8631 8000',
      'You have a pending transaction of P12,500. Tap to review and confirm.',
      'BDO Fake Support #5',
      '68%',
      'Suspicious',
      'May 13, 8:33 AM',
    ...
    [
      '#MSG-4818',
      '+63 919 100 4567',
      'Ang inyong BDO account ay nangangailangan ng verification. Mag-click dto...',
      'BDO Fake Support #5',
      '89%',
      'Smishing',
      'May 13, 8:20 AM',
    ...
    [
      '#MSG-4817',
      '+63 927 888 3210',
      'URGENT: Your LBC parcel #PH8812 is held at customs. Pay release fee at...',
      'LBC Parcel Scam #8',
      '96%',
      'Smishing',
      'May 13, 7:58 AM',
    ...
    [
      '#MSG-4816',
      '+63 908 111 2222',
      'Your PLDT bill of P1,899 is overdue. Avoid disconnection --- pay now at...',
      'PLDT Impersonation #4',
      '82%',
      'Smishing',
      'May 13, 7:44 AM',
      'View ---',
    ...
    [
      '#MSG-4815',
      '+63 955 321 0099',
      'SHOPEE NOTICE: Your prize of P10,000 is waiting! Claim within 24 hours.',
      'Shopee Prize Lure #11',
      '88%',
      'Smishing',
      'May 13, 7:12 AM',
      'View ---',
    ...
    [
      '#MSG-4814',
      '+63 917 000 5544',
      'Meralco disconnection notice: Your account balance is overdue.',
      'Meralco Threat #2',
      '71%',
      'Suspicious',
      'May 13, 6:30 AM',
    ...
    [
      '#MSG-4812',
      '+63 908 777 3321',
      'Congratulations! You won a P5,000 Shopee voucher. Tap link to claim.',
      'Shopee Prize Lure #11',
      '85%',
      'Smishing',
      'May 13, 5:58 AM',
    ...
    [
      '#MSG-4812',
      '+63 932 441 8000',
      'GCash Security Alert: Unusual login from new device. Verify immediately.',
      'Op. GCash Clone #17',
      '93%',
      'Smishing',
      'May 13, 5:21 AM',
...
export const analyticsVariants = [
  [
    'Variant A',
    'Your GCash account has been flagged for suspicious activity...',
    '97.4%',
    'red',
  ],
  [
    'Variant B',
    '"GCASH NOTICE: Unusual login detected. Secure your account..."',
    '89.1%',
    'red',
  ],
  [
    'Variant C',
    '"Congratulations! Your GCash wallet has been selected for..."',
    '81.7%',
    'amber',
  ],
] as const;
...
export const helpFaqs = [
  [
    ...
    "The confidence score (0-100%) reflects the model's certainty that a message is smishing. Scores above 80% are flagged as Likely Smishing; 50-79% are Suspicious. Scores below 50% are generally treated as Unknown / Safe.",
  ],
  [
    'What is a Campaign?',
    'A campaign is a coordinated cluster of smishing messages that share similar patterns --- same fake domain, brand, or phrasing. BantAI groups related messages into named campaigns so you can track them over time.',
  ],
  [
    'Can I export my data?',
    'Yes. Go to Export Reports to download your classification log as CSV. Exports are scoped to your organization and do not include raw sender numbers.',
  ],
  [
    'How do I interpret the Analytics page?',
    "The analytics page shows pattern breakdowns per campaign. Use the campaign selector to switch context. The progress bars show how frequently each evasion tactic appears in that cluster's messages.",
  ],
  [
    'Why do some messages show "Suspicious" instead of "Smishing"?',
    'Suspicious messages contain some smishing indicators but not enough for a high-confidence classification. They are included in your log so your team can manually review borderline cases.',
  ],
  [
    'How often is the data updated?',
    'Classifications are processed in near real-time as BantAI app users submit reports. Campaign clusters are updated daily. Your dashboard refreshes data as alerts are pushed.',
  ],
];
...
export const notifications = [
  ...
  [
    'Daily Report --- May 13',
    '312 reports processed today - 23 confirmed smishing - 8 suspicious flagged',
    '6h ago',
    'blue',
  ],
  [
...
export const adminReports: TableData = {
  ...
  rows: [
    [
      '#RPT-0912',
      'user_4821',
      'Your GCash account has been flagged. Verify now at gcash-ph...',
      'Op. GCash Clone #17',
      'Smishing / Fake Domain',
      'May 13 9:01 AM',
      'Pending',
      'Review',
    ],
    [
      '#RPT-0911',
      'user_3340',
      "Congratulations! You've won a P5,000 GCash reward. Claim at...",
      'Op. GCash Clone #17',
      'Smishing / Prize Lure',
      'May 13 8:47 AM',
      'Pending',
    ...
    [
      '#RPT-0910',
      'user_7102',
      'Your PLDT bill is overdue. Pay now to avoid disconnection.',
      'PLDT Impersonation #4',
      'Smishing / Urgency',
      'May 13 8:30 AM',
      'Validated',
    ...
    [
      '#RPT-0909',
      'user_2211',
      'Ang inyong BDO account ay nangangailangan ng verification.',
      'BDO Fake Support #5',
      'Smishing / Brand Impersonation',
      'May 13 7:55 AM',
      'Validated',
      'View ---',
    ],
    [
      '#RPT-0908',
      'user_8830',
      'URGENT: LBC parcel held at customs. Pay release fee.',
      'LBC Parcel Scam #8',
      'Smishing / Fake Domain',
      'May 13 7:40 AM',
      'Pending',
    ...
    [
      '#RPT-0907',
      'user_4401',
      'Meralco disconnection notice for your account.',
      'Meralco Threat #2',
      'Suspicious / Urgency',
      'May 13 6:50 AM',
      'Rejected',
    ...
    [
      '#RPT-0906',
      'user_9912',
      'SHOPEE: Your P10,000 prize is waiting. Claim within 24h.',
      'Shopee Prize Lure #11',
      'Smishing / Prize Lure',
      'May 13 6:20 AM',
      'Pending',
...
export const classificationLog: TableData = {
  ...
  rows: [
    [
      ...
      '+63 908 000 1234',
      'Taglish',
      'Your GCash account has been flagged...',
      'Smishing',
      '94%',
      'Op. GCash Clone #17',
      '---',
    ...
    [
      ...
      '+63 917 231 5500',
      'Taglish',
      "You've been selected for a P5,000 reward...",
      'Smishing',
      '91%',
      'Op. GCash Clone #17',
      '---',
    ...
    [
      ...
      '+63 2 8631 8000',
      'English',
      'You have a pending transaction of P12,500...',
      'Suspicious',
      '68%',
      'BDO Fake Support #5',
      '---',
    ...
    [
      ...
      '+63 927 888 3210',
      'English',
      'URGENT: Your LBC parcel is held...',
      'Smishing',
      '96%',
      'LBC Parcel Scam #8',
      '---',
    ...
    [
      ...
      'GCash',
      'English',
      'You have successfully loaded P100...',
      'FP',
      '55%',
      '---',
      'FP',
...
export const fpfnReview: TableData = {
  ...
  rows: [
    ...
    [
      'FP-040',
      'GCash',
      '"You have successfully sent P100 to Juan dela Cruz."',
      'Smishing',
      '55%',
      'user_7891',
      'May 11',
    ...
    [
      'FP-039',
      'BPI Direct',
      '"Your BPI savings account statement is now available."',
      'Suspicious',
      '62%',
      'user_2201',
      'May 10',
...
export const scamTips: TableData = {
  ...
  rows: [
    ...
    [
      '2',
      'Huwag i-click ang mga link mula sa hindi kilalang number',
      'Link Safety',
      'Tagalog',
      'Published',
      'May 9',
    ...
    [
      '3',
      'How to identify fake GCash domains',
      'Fake Domains',
      'English',
      'Published',
      'May 8',
    ...
    [
      '4',
      'Recognizing urgency pressure tactics in scam messages',
      'General',
      'English',
      'Published',
      'May 7',
